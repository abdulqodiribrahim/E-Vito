...
@Component({
  selector: 'ngx-finishing-dialog',
  templateUrl: './finishing-dialog.component.html',
  styleUrls: ['./finishing-dialog.component.scss']
})
export class FinishingDialogComponent implements OnInit {
  ...
  constructor(protected ref: NbDialogRef<FinishingDialogComponent>, private service: SalesData, private dataTable: DataTableService) {
