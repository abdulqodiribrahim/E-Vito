...
@Component({
  selector: 'ngx-sewing-dialog',
  templateUrl: './sewing-dialog.component.html',
  styleUrls: ['./sewing-dialog.component.scss']
})
export class SewingDialogComponent implements OnInit {
  ...
  constructor(protected ref: NbDialogRef<SewingDialogComponent>, private service: SalesData, private dataTable: DataTableService) {
